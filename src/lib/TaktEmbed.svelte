...
<iframe {title} {width} {height} loading="lazy" style="border:0" {...rest} {src} referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin"></iframe>
